import type { LocalizationMap, APIApplicationCommandIntegerOption } from '../../index';

import { ApplicationCommandBaseOptionBuilder } from './BaseOptionBuilder';

export class ApplicationCommandIntegerOptionBuilder extends ApplicationCommandBaseOptionBuilder {
    ...
    public constructor(data?: APIApplicationCommandIntegerOption) {
        super('Integer');
